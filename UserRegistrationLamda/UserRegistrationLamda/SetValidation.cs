...
namespace UserRegistrationLamda
{
    public class SetValidation
    {
        ...
        //        if (lName == null)
        //        {
        //            throw new CustomException(CustomException.ExceptionType.NULL_INPUT, "Input should not be null"); //throwing exception when first name is null
        //        }
        //        if (lName.Equals(string.Empty))
        //        {
        //            throw new CustomException(CustomException.ExceptionType.EMPTY_INPUT, "Input should not be empty"); //throwing exception when first name is empty
        //        }
        ...
        //        else
        //        {
        //            throw new CustomException(CustomException.ExceptionType.EMPTY_INPUT, "Input is not valid");//throwing exception when first name is not valid
        //        }

        //    }
        //    catch (CustomException ex) // If any exception throws then print exception message
        //    {
        //        Console.WriteLine("\n" + ex.Message);
        //        return ex.Message;
        //    }
        ...
        //        if (email == null)
        //        {
        //            throw new CustomException(CustomException.ExceptionType.NULL_INPUT, "Input should not be null"); //throwing exception when email is null
        //        }
        //        if (email.Equals(string.Empty))
        //        {
        //            throw new CustomException(CustomException.ExceptionType.EMPTY_INPUT, "Input should not be empty"); //throwing exception when email is empty
        //        }
        ...
        //        else
        //        {
        //            throw new CustomException(CustomException.ExceptionType.EMPTY_INPUT, "Input is not valid");//throwing exception when email is not valid
        //        }
        ...
        //        {
        //            throw new CustomException(CustomException.ExceptionType.NULL_INPUT, "Input should not be null"); //throwing exception when mobile number is null
        //        }
        ...
        //        else
        //        {
        //            throw new CustomException(CustomException.ExceptionType.EMPTY_INPUT, "Input is not valid");//throwing exception when mobile number is not valid
        //        }
        ...
        //        if (password == null)
        //        {
        //            throw new CustomException(CustomException.ExceptionType.NULL_INPUT, "Input should not be null"); //throwing exception when password is null
        //        }
        //        if (password.Equals(string.Empty))
        //        {
        //            throw new CustomException(CustomException.ExceptionType.EMPTY_INPUT, "Input should not be empty"); //throwing exception when password is empty
        //        }
        ...
        //        else
        //        {
        //            throw new CustomException(CustomException.ExceptionType.EMPTY_INPUT, "Input is not valid");//throwing exception when password is not valid
        //        }
